...
namespace GABS2025324AppWebMVC.Controllers
{
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BrandsId,BrandName,Country")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BrandsId,BrandName,Country")] Brand brand)
        {
            if (id != brand.BrandsId)
            {
                return NotFound();
            }
